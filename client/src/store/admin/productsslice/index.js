...
export const fetchAllProduct = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await axios.get("e-commerce-website-amefbyngx-orbnirrs-projects.vercel.app/api/admin/products/get");
...
export const addNewProduct = createAsyncThunk(
    ...
    async (formData, { rejectWithValue }) => {
        try {
            const response = await axios.post("e-commerce-website-amefbyngx-orbnirrs-projects.vercel.app/api/admin/products/add", formData, {
    ...
    async ({ id, formData }, { rejectWithValue }) => {
        try {
            const response = await axios.put(
                `e-commerce-website-amefbyngx-orbnirrs-projects.vercel.app/api/admin/products/edit/${id}`,
                formData,
                { headers: { "Content-type": "application/json" } }
            );
            return response.data;
    ...
    async (id, { rejectWithValue }) => {
        try {
            const response = await axios.delete(
                `e-commerce-website-amefbyngx-orbnirrs-projects.vercel.app/api/admin/products/delete/${id}`,
                { headers: { "Content-type": "application/json" } }
            );
            return response.data;
        } catch (error) {
